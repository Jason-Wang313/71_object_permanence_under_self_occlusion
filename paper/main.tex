...
\usepackage{url}
\usepackage{booktabs}
\title{Object Permanence Under Self-Occlusion: ICLR Main-Conference Gate Archive}
\author{Anonymous Authors}
\begin{document}
\maketitle
\begin{abstract}
This document is not an ICLR main-conference submission. It is the v3 main-conference gate for a generated robotics draft about robot scene memory and manipulation. The original research bet was: Make self-occlusion by the robot a distinct world-model failure mode. After a stricter hostile review, the honest terminal decision is \textbf{KILL/ARCHIVE}. Submission-hardening version: v3.
\end{abstract}
...
\item Vision-language model-driven scene understanding and robotic object manipulation (2024)
\item Self-Supervised Learning of Multi-Object Keypoints for Robotic Manipulation (2022)
\item Scaling Cross-Environment Failure Reasoning Data for Vision-Language Robotic Manipulation (2025)
\item Study of Failure Mode and Ultimate Bearing Capacity for Self-Centering SMA Connection (2025)
\end{itemize}
