...
This repository contains a hardened, honest workshop-only robotics paper draft for `object_permanence_under_self_occlusion`.
...
Canonical local PDF path: `C:/Users/wangz/Downloads/71.pdf`
