...
Honest strongest claim: `Make self-occlusion by the robot a distinct world-model failure mode.` is a plausible branch-structured mechanism for robot scene memory and manipulation, supported by synthetic multi-seed diagnostic evidence and hostile-prior-work-aware positioning.
